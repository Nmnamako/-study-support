class UsersController < ApplicationController
  ...
  def my_page
    ...
    # @day1_total_times = total(@day1)
    @day2_total_times = total(@day2)
    @day3_total_times = total(@day3)
    @day4_total_times = total(@day4)
    @day5_total_times = total(@day5)
    @day6_total_times = total(@day6)
    @day7_total_times = total(@day7)
